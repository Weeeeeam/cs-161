...
def problem6():
    def dogs_age_calculator():
        """this function calculates the age of the dog by taking the dogs age and name for the usert and saving it to tell them later after some math"""
        print('dogs age calculator:')
        dogs_name = input("please enter your dog's name: ")
        dogs_age = float(input("please enter your dogs age in years: "))
        age_in_human_years = 24+ (dogs_age-2)*4
        return age_in_human_years, dogs_name
    age_in_human_years, dogs_name = dogs_age_calculator()
    print(f'your {dogs_name} is {age_in_human_years} in human years')
    dogs_age_calculator()

def problem7():
    number_of_scoops = input_int("please enter how many scoops you would like")
    price = number_of_scoops*1.15+2.25
    print(f'{number_of_scoops} scoops will cost {price}$')
problem7()